              ...
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="../models/edit_categorie.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                          <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="../models/delete_categorie.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">
